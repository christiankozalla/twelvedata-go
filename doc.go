...
//   - market data endpoints such as exchange rate, currency conversion, quote, price, eod, logo, profile, market cap, statistics, income statement, income statement consolidated, and last changes
