...
- Market data: `ExchangeRate`, `CurrencyConversion`, `Quote`, `Price`, `EOD`, `Logo`, `Profile`, `MarketCap`, `Statistics`, `EarningsEstimate`, `IncomeStatement`, `IncomeStatementConsolidated`, `LastChanges`
